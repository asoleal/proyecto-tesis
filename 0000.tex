...
\renewcommand{\thesisname}{Medición, Reporte y Validación de Variables Ambientales y Gases de Efecto Invernadero en la Valorización de Residuos mediante Mosca Soldado Negra: Un Enfoque Basado en Internet de las Cosas e Inteligencia Artificial}
\renewcommand{\issuedate}{2025}
\renewcommand{\submissiondate}{20 de Octubre}
\renewcommand{\director}{Director Dr. Luis Octavio Gonzales Salcedo}
\renewcommand{\codirector}{Codirector Dr.}
...
\renewcommand{\department}{Departamento de Ciencias Básicas}
...
\renewcommand{\palabrasclave}{Modelamiento matemático, Ecuación de Richards, Medios Porosos} 
...
% Título de la tesis
{\LARGE \textbf{\thesisname}} \\[1.5cm]

% Línea decorativa intermedia
\rule{\textwidth}{0.5pt} \\[1cm]

% Nombre del estudiante
{\large \textbf{\studentname}} \\[1cm]

% Tipo de documento
{\large \textbf{Proyecto de Tesis}} \\[1.5cm]

% Información del director y codirector
{\large \textbf{\director}} \\[0.2cm]
%{\large \textbf{\codirector}} \\[1.5cm]

% Línea decorativa inferior
%\rule{\textwidth}{0.8pt} \\[0.5cm]

% Fecha de emisión
{\large \textbf{\issuedate}} \\[0.5cm]
\end{center}
}
% \newpage
% \thispagestyle{empty}
