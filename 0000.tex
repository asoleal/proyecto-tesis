...
\renewcommand{\thesisname}{Sistema Inteligente para el Modelado y Predicción de Emisiones de GEI en la Bioconversión de Residuos con \textit{Hermetia illucens}}
...
% Fecha de emisión
{\large \textbf{Julio, \issuedate}} \\[0.5cm]
\end{center}
}
% \newpage
% \thispagestyle{empty}
